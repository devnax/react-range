...
var jpath = _interopDefault(require('jsonpath'));
...
var Render = function Render(_ref) {
  ...
  var _useState = React.useState(Math.random().toString()),
  ...
  return /*#__PURE__*/React__default.createElement(Comp, _extends({}, props, {
    store: store
  }));
};
...
var withStore = (function (Comp, resolve) {
  if (typeof resolve === 'function') {
    return function (props) {
      ...
      return React.useMemo(function () {
        return /*#__PURE__*/React__default.createElement(Render, _extends({}, deps, props, {
          Comp: Comp
        }));
      }, Object.values(deps));
    };
  ...
  return function (props) {
    return /*#__PURE__*/React__default.createElement(Render, _extends({}, props, {
      Comp: Comp
    }));
  };
});
...
exports.is_callback = is_callback;
exports.is_define = is_define;
